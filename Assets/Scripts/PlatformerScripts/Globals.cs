...
//Collections = Containers, Generic = Template, 
//C++ List is a linked list, C# List is like a vector, and C# LinkedList is its own thing

public class Globals : MonoBehaviour
{
    public static GameObject globalsObject;
    public static GameObject playerObject;
    public static List<Checkpoint> staticCheckpoints;
    ...
    {
        //Reason to put this in Awake is to make sure these references are set
        //before any object's Start function tries to use them
